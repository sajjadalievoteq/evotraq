...
class GtinSelectorBody extends StatefulWidget {
  final String label;
  ...
  const GtinSelectorBody({super.key,
    required this.label,
    this.hintText,
    this.initialValue,
    this.initialGtins,
  ...
  @override
  State<GtinSelectorBody> createState() => GtinSelectorBodyState();
}

class GtinSelectorBodyState extends State<GtinSelectorBody> {
  ...
  @override
  void didUpdateWidget(GtinSelectorBody oldWidget) {
