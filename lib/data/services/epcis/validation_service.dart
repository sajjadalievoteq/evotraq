...
class ValidationService {
  ...
  ValidationService({required DioService dioService})
    : _dioService = dioService;

  Future<Map<String, dynamic>> validateObjectEvent(
    Map<String, dynamic> eventData,
  ) async {
    return _validateEventRequest('/validate/object-event', eventData);
  }

  Future<Map<String, dynamic>> validateObjectEventModel(
    ObjectEvent event,
  ) async {
    return validateObjectEvent(event.toJson());
  }

  Future<Map<String, dynamic>> validateAggregationEvent(
    Map<String, dynamic> eventData,
  ) async {
    return _validateEventRequest('/validate/aggregation-event', eventData);
  }

  Future<Map<String, dynamic>> validateAggregationEventModel(
    AggregationEvent event,
  ) async {
    return validateAggregationEvent(event.toJson());
  }

  Future<Map<String, dynamic>> validateTransactionEvent(
    Map<String, dynamic> eventData,
  ) async {
    return _validateEventRequest('/validate/transaction-event', eventData);
  }

  Future<Map<String, dynamic>> validateTransactionEventModel(
    TransactionEvent event,
  ) async {
    return validateTransactionEvent(event.toJson());
  }

  Future<Map<String, dynamic>> validateTransformationEvent(
    Map<String, dynamic> eventData,
  ) async {
    return _validateEventRequest('/validate/transformation-event', eventData);
  }

  Future<Map<String, dynamic>> validateTransformationEventModel(
  ...
  Future<Map<String, dynamic>> _validateEventRequest(
    String endpoint,
    Map<String, dynamic> eventData,
  ) async {
    try {
      ...
      return {'valid': false, 'error': 'Error connecting to server: $e'};
    }
  }
}
