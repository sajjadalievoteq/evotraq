...
class CbvVocabularyManagementView extends StatefulWidget {
  ...
  State<CbvVocabularyManagementView> createState() =>
      CbvVocabularyManagementViewState();
}

class CbvVocabularyManagementViewState
    extends State<CbvVocabularyManagementView>
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      setState(
        () => _searchQuery = normalizeCbvSearchQuery(_searchController.text),
      );
    });
  }
  ...
  Future<void> _confirmDelete(
    ...
    try {
      if (isBizStep) {
        ...
        await context.read<AdminCbvVocabularyCubit>().deleteDisposition(
          item.code,
        );
      }
