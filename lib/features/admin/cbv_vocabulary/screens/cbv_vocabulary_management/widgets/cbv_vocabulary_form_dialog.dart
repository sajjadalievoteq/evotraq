...
import 'package:traqtrace_app/features/admin/cbv_vocabulary/screens/cbv_vocabulary_management/utils/cbv_vocabulary_form_utils.dart';
...
class _CbvVocabularyFormDialogState extends State<_CbvVocabularyFormDialog> {
  ...
  void _onLabelChanged() {
    ...
    final generated = labelToCbvCode(_labelController.text);
  ...
  Future<void> _submit() async {
    ...
    final result = CbvVocabularyFormResult(
      ...
      urn: computeCbvUrn(
        isBizStep: widget.type == CbvVocabType.bizStep,
        code: _codeController.text.trim(),
      ),
      enabled: _enabled,
  ...
  Widget build(BuildContext context) {
    ...
    final urnPreview = computeCbvUrn(
      isBizStep: widget.type == CbvVocabType.bizStep,
      code: _codeController.text.trim(),
    );
