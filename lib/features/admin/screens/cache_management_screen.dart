        ...
        children: [
          ...
          _buildHelpSection(
            ...
            [
              ...
              '   • Image: redis:7-alpine (see docker-compose.yml at repo root)',
              '   • Port: 6379 (localhost)',
              '   • Password: None (development only)',
              '',
              '🚀 Quick setup (from TraqTrace repository root):',
              '   1. Install Docker Desktop',
              '   2. Run: docker compose up -d redis',
              '   3. Verify: docker compose ps   or   docker exec traqtrace-redis redis-cli ping',
              '   4. Stop: docker compose stop redis',
              '   5. Start: docker compose start redis',
              '',
          ...
          _buildHelpSection(
            ...
            [
              ...
              '   2. Start from repo root: docker compose up -d redis',
