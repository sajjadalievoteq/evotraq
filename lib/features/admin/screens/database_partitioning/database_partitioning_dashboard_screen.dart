...
import 'package:traqtrace_app/features/admin/screens/database_partitioning/widgets/partition_help_section.dart';
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          KeepAliveTabView(
            child: PartitionMaintenanceTab(onPerformMaintenance: _performMaintenance),
          ),
        ],
      ),
    );
