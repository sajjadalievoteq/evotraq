...
import 'package:traqtrace_app/features/auth/screens/reset_password/widgets/reset_password_form_widget.dart';
      ...
      child: BlocConsumer<AuthCubit, AuthState>(
        ...
        builder: (context, state) {
          ...
          return TraqStatusSwitcher(
            statusKey: ResetPasswordStatusUtils.statusKey(state),
            child: body,
          );
        },
      ),
