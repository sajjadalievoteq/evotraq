...
import '../models/cache_health.dart';
...
class CacheService {
  ...
  CacheService() : _httpService = HttpService();

  /// Get all cache statistics
  Future<CacheStatistics?> getAllCacheStatistics() async {
    try {
      final response = await _httpService.get('/cache/statistics');
  ...
  Future<Map<String, dynamic>?> getQueryCacheStatistics() async {
    try {
      final response = await _httpService.get('/cache/statistics/query-results');
  ...
  Future<CacheHealth?> getCacheHealth() async {
    try {
      final response = await _httpService.get('/cache/health');
  ...
  Future<Map<String, dynamic>?> getDistributedCacheHealth() async {
    try {
      final response = await _httpService.get('/cache/distributed/health');
      return response.data;
    } catch (e) {
  ...
  Future<bool> warmUpCache() async {
    try {
      await _httpService.post('/cache/warm-up', data: {});
  ...
  Future<bool> clearQueryResultCache() async {
    try {
      await _httpService.delete('/cache/query-results');
  ...
  Future<bool> evictQueryResult(String queryKey) async {
    try {
      await _httpService.delete('/cache/query-results/$queryKey');
  ...
  Future<bool> clearMasterDataCache(String dataType) async {
    try {
      await _httpService.delete('/cache/master-data/$dataType');
  ...
  Future<bool> evictMasterData(String dataType, String key) async {
    try {
      await _httpService.delete('/cache/master-data/$dataType/$key');
  ...
  Future<bool> refreshMasterDataCache() async {
    try {
      await _httpService.post('/cache/master-data/refresh', data: {});
  ...
  Future<bool> clearHotDataCache() async {
    try {
      await _httpService.delete('/cache/hot-data');
  ...
  Future<bool> identifyAndCacheHotData() async {
    try {
      await _httpService.post('/cache/hot-data/identify', data: {});
  ...
  Future<bool> synchronizeCache() async {
    try {
      await _httpService.post('/cache/synchronize', data: {});
  ...
  Future<bool> clearAllCaches() async {
    try {
      await _httpService.delete('/cache/all');
