...
import 'package:traqtrace_app/features/epcis/aggregation_events/screens/aggregation_event_detail/utils/aggregation_event_detail_formatters.dart';
...
import 'package:traqtrace_app/features/epcis/aggregation_events/screens/aggregation_event_detail/widgets/aggregation_event_detail_field.dart';
        ...
        children: [
          ...
          EpcContentsCard(
            ...
            epcs: mergeModelEpcFields(
              leading: event.parentID.isNotEmpty ? event.parentID : null,
              trailing: event.childEPCs,
            ),
            emptyMessage: 'No EPCs',
            hierarchyScreenTitle: 'Aggregation Hierarchy',
          ),
          Gs1GroupCard(
