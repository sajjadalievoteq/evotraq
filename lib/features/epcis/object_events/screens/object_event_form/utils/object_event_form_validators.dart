...
class ObjectEventFormValidators {
  ...
  static String? validateBusinessStepCbv(
    ...
    if (!CbvVocabularyFormatter.isValidBizStepFormat(versionString, value)) {
      if (epcisVersion == EPCISVersion.v2_0) {
        return 'Business Step should follow GS1 CBV 2.0 business-step URI format.';
      }
      return 'Business Step should follow GS1 CBV 1.3 business-step URN format.';
    }
    return null;
  }
  ...
  static String? validateCustomDisposition(
    ...
    if (!CbvVocabularyFormatter.isValidDispFormat(versionString, value)) {
      if (epcisVersion == EPCISVersion.v2_0) {
        return 'Disposition should follow GS1 CBV 2.0 disposition URI format.';
      }
      return 'Disposition should follow GS1 CBV 1.3 disposition URN format.';
    }
    return null;
  }
