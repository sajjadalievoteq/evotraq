abstract final class AggregationPharmaRulesText {
  ...
  static const List<String> rules = [
    ...
    'Every item SGTIN must be commissioned and in COMMISSIONED, ACTIVE, or RECEIVED status.',
    'All items must be under your custody at the selected location GLN.',
    'All items must be physically at the same location as the parent container when packing or repacking.',
    'Items must share the same custodian as the parent box or case.',
  ...
  static const String childEpcsHint =
      'Each item must be commissioned, at your location, and match the parent container custody.';
