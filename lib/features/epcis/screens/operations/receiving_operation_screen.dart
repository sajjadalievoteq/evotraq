...
class _ReceivingOperationScreenState extends State<ReceivingOperationScreen> {
    ...
    switch (_currentStep) {
      case 0:
        ...
        if (_receivingGLN == null) {
          setState(() {
            _receivingGLNError = 'Receiving GLN is required';
          });
          isValid = false;
        }
        if (_sourceGLN == null) {
  ...
  Future<void> _submitReceivingOperation() async {
    ...
    try {
      ...
      _showError('Error creating receiving operation: $e');
    } finally {
      if (mounted) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Enter the reference information for this receiving operation.',
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              labelText: 'Reference *',
              hintText: 'Enter receiving reference',
              border: OutlineInputBorder(),
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              setState(() {
                _receivingCondition = value ?? 'GOOD';
              });
            },
          ),
          const SizedBox(height: 24),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                'Received Items (${_scannedEPCs.length})',
                style: Theme.of(context).textTheme.titleMedium,
              ),
              const Spacer(),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildGLNReviewField('Source GLN (From)', _sourceGLN),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Once submitted, this receiving operation cannot be modified. Please ensure all details are correct.',
