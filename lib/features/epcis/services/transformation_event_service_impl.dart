...
class TransformationEventServiceImpl implements TransformationEventService {
  ...
  Future<TransformationEvent> getTransformationEventById(String id) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to get transformation event: ${response.statusCode}');
    }
  }  @override
  Future<TransformationEvent> getTransformationEventByEventId(String eventId) async {
    final headers = await _getHeaders();
  ...
  Future<TransformationEvent> createTransformationEvent(TransformationEvent event) async {
    ...
    if (response.statusCode == 201) {
      ...
      throw Exception('Failed to create transformation event: ${response.statusCode}');
    }
  }

  @override
  Future<TransformationEvent> updateTransformationEvent(String id, TransformationEvent event) async {
    final headers = await _getHeaders();
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to update transformation event: ${response.statusCode}');
    }
  }
  ...
  @override
  Future<List<TransformationEvent>> findTransformationEventsByTransformationId(String transformationId) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to find transformations by transformation ID: ${response.statusCode}');
    }
  }
  @override
  Future<List<TransformationEvent>> findTransformationEventsByInputEPC(String inputEPC) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to find transformation events: ${response.statusCode}');
    }
  }
  @override
  Future<List<TransformationEvent>> findTransformationEventsByOutputEPC(String outputEPC) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
  ...
  @override
  Future<List<TransformationEvent>> findTransformationEventsByInputEPCClass(String inputEPCClass) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
  ...
  @override
  Future<List<TransformationEvent>> findTransformationEventsByOutputEPCClass(String outputEPCClass) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
  ...
  Future<List<TransformationEvent>> findTransformationEventsByParameter(
      String paramName, String paramValue) async {
    final headers = await _getHeaders();
  ...
  @override
  Future<List<TransformationEvent>> findTransformationHistoryForOutput(String outputEPC) async {
    final headers = await _getHeaders();
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to find transformation history: ${response.statusCode}');
    }
  }
  @override
  ...
  Future<TransformationEvent> createTransformationProcess(
    ...
    if (response.statusCode == 201) {
      ...
      throw Exception('Failed to create transformation process: ${response.statusCode}');
    }
  }
  ...
  Future<List<TransformationEvent>> findTransformationsByEPC(String epc) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to find transformations for EPC: ${response.statusCode}');
    }
  }

  @override
  Future<List<TransformationEvent>> findTransformationsByInputAndOutputEPC(String inputEPC, String outputEPC) async {
    final headers = await _getHeaders();
    final response = await _httpClient.get(
      Uri.parse('$_baseUrl/input-output?inputEPC=$inputEPC&outputEPC=$outputEPC'),
      headers: headers,
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to find transformations by input-output relationship: ${response.statusCode}');
    }
  }
}