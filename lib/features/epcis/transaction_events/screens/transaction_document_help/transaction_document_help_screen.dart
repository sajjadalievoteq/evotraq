...
class TransactionDocumentHelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Transaction Document Help')),
        ...
        child: Column(
          ...
          children: [
            const TransactionDocumentHelpSection(
              ...
              content:
                  'Transaction documents are business documents used in supply chain operations that are referenced '
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'Document types are typically standardized identifiers for the kind of document being referenced. '
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function allows you to find all EPCIS Transaction Events that reference a specific document.\n\n'
                  'Example inputs:\n'
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function checks if a document reference exists in the system and is valid.\n\n'
                  'Example inputs:\n'
                  '• Document Type: po\n'
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function retrieves the current status and metadata about a document.\n\n'
                  'Example inputs:\n'
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function finds other documents that are related to the specified document.\n\n'
                  'Example inputs:\n'
                  '• Document Type: invoice\n'
                  '• Document ID: INV-12345\n\n'
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function creates a relationship between two documents.\n\n'
                  'Example inputs:\n'
                  '• Source Type: po\n'
                  '• Source ID: PO-67890\n'
                  '• Target Type: invoice\n'
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  'This function finds the original document where a specific item (identified by its EPC) '
            ...
            const TransactionDocumentHelpSection(
              ...
              content:
                  '1. A manufacturer creates a purchase order (PO-67890)\n\n'
