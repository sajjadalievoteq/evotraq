    ...
    final body = BlocConsumer<GLNCubit, GLNState>(
      ...
      builder: (context, state) {
        ...
        return GlnDetailFormBody(
          ...
          locationReferenceDigitsController: _locationReferenceDigitsController,
          checkDigitController: _checkDigitController,
          parentGlnCodeController: _parentGlnCodeController,
          glnExtensionComponentController: _glnExtensionComponentController,
          ...
          taxRegistrationNumberController: _taxRegistrationNumberController,
          ...
          mobileLocationIdentifierController: _mobileLocationIdentifierController,
