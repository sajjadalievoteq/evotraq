...
mixin GS1FormValidationMixin<T extends StatefulWidget> on State<T> {
  ...
  String? validateGS1CheckDigit(String? value, {bool includesCheckDigit = true}) {
    if (value == null || value.isEmpty) {
      return 'Value is required';
    }
  ...
  String? validateEPCURI(String? value) {
    ...
    final epcUriPattern = RegExp(r'^urn:epc:(id|class|idpat):(sgtin|sscc|sgln|grai|giai|gsrn|gdti|cpi):.+$');
