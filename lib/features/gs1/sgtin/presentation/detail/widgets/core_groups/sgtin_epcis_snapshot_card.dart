...
/// Read-only EPCIS event snapshot card for the SGTIN detail screen.
///
/// Shows the latest business step, disposition, and event ID from the EPCIS
/// record. Only rendered when viewing an existing SGTIN record.
