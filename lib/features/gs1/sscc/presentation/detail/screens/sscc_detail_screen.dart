...
import 'package:traqtrace_app/data/models/gs1/sscc/sscc_route_constants.dart';
...
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/tobacco/sscc_tobacco_extension_widget.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/pharma/sscc_pharmaceutical_extension_widget.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/utilities/sscc_ui_constants.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_aggregation_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_pharma_compliance_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_epcis_audit_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_parties_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_transport_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_classification_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_dates_card.dart';
import 'package:traqtrace_app/features/gs1/sscc/presentation/detail/widgets/core_groups/sscc_lifecycle_status_card.dart';
...
class _SSCCDetailScreenState extends State<SSCCDetailScreen>
  ...
  Future<void> _saveSSCC() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      } else if (widget.isEditing && _sscc?.id != null) {
  ...
  Widget build(BuildContext context) {
    ...
    final allowMasterDataActions = canEditMasterData &&
        ...
        (widget.isEditing || widget.isCreating);
  ...
  Widget _buildForm({
    ...
    final isReadOnly = !widget.isEditing && !widget.isCreating;
        ...
        child: Form(
          ...
          child: Gs1FormShimmerLayer(
            ...
            SsccClassificationCard(
              ...
              containedExpiry: _containedExpiry,
              onContainedExpiryChanged: isReadOnly
                  ? null
                  : (d) => setState(() => _containedExpiry = d),
            ),
            ...
            SsccDatesCard(
              ...
              packingDate: _packingDate,
              sscc: _sscc,
              onPackingDateSelected: () => _selectDate(context, (date) {
                setState(() => _packingDate = date);
              }),
            ),
            if (!widget.isCreating) ...[
              const SizedBox(height: 12),
              ...
              SsccAggregationCard(
                ...
                isReadOnly: isReadOnly,
                onAddChild: isReadOnly || _sscc?.id == null
                    ? null
                    : _addAggregationChild,
                onDisaggregate: isReadOnly ? null : _disaggregateChild,
              ),
              const SizedBox(height: 12),
              SsccEpcisAuditCard(
                borderColor: borderColor,
