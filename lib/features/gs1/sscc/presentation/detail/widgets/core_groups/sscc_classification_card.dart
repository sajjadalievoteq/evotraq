...
class SsccClassificationCard extends StatelessWidget {
  ...
  final ValueChanged<DateTime?>? onContainedExpiryChanged;
        ...
        children: [
          ...
          DropdownButtonFormField<ContentHomogeneity>(
            decoration: const InputDecoration(
              ...
              helperText: 'Homogeneous (AI 02/37) vs mixed contents',
              border: OutlineInputBorder(),
            ),
          ...
          if (containedQuantityController != null &&
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: 'Contained Quantity (AI 37)',
                border: OutlineInputBorder(),
              ),
          ...
          if (containedBatchController != null &&
            ...
            TextFormField(
              ...
              readOnly: isReadOnly,
              decoration: const InputDecoration(
                labelText: 'Contained Batch (AI 10)',
                border: OutlineInputBorder(),
              ),
            ),
          ],
          if (contentHomogeneity == ContentHomogeneity.HOMOGENEOUS) ...[
            ...
            ListTile(
              ...
              title: const Text('Contained Expiry (AI 17)'),
              subtitle: Text(
                containedExpiry != null
                    ? '${containedExpiry!.year}-${containedExpiry!.month.toString().padLeft(2, '0')}-${containedExpiry!.day.toString().padLeft(2, '0')}'
                    : 'Not set',
              ),
              trailing: isReadOnly
                  ? null
                  : IconButton(
                      ...
                      onPressed: () async {
                        final picked = await showDatePicker(
                          context: context,
                          initialDate: containedExpiry ?? DateTime.now(),
                          firstDate: DateTime(2000),
                          lastDate: DateTime(2100),
                        );
                        if (picked != null) {
                          onContainedExpiryChanged?.call(picked);
                        }
                      },
                    ),
            ),
