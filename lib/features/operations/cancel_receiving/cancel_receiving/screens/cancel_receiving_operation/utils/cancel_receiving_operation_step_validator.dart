...
class CancelReceivingOperationStepValidator {
  ...
  static String? validateReferenceStep({
    ...
    if (sourceGln == null) {
      return 'Please select the original Sender (Ship-From) location (required for GS1 cancel receiving).';
    }
    if (receivingGln == null) {
      return 'Please select the original Receive-At location (required for DSCSA audit trail).';
    }
