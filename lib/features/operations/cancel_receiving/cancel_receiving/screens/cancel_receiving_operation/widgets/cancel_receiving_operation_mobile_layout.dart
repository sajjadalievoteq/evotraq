...
/// Mobile wizard layout for shipping operation screen.
class CancelReceivingOperationMobileLayout extends StatelessWidget {
  const CancelReceivingOperationMobileLayout({
    super.key,
