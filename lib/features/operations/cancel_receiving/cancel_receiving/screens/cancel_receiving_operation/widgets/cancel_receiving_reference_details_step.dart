...
class CancelReceivingReferenceDetailsStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ShipmentReferenceDetailsStep(
        ...
        sourceGln: sourceGln,
        sourceGlnLabel: 'Original Sender (Ship-From) Location (Shipper)',
        ...
        receivingGlnLabel: 'Originally Intended Receive-At Location',
        receivingGlnHint: 'Search and select the intended recipient GLN',
        receivingGlnError: receivingGlnError,
        onReceivingGlnChanged: onReceivingGlnChanged,
        eventTime: eventTime,
