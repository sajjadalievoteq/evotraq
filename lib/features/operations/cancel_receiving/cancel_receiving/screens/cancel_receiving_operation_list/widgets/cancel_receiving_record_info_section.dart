...
class CancelReceivingRecordInfoSection extends StatelessWidget {
  const CancelReceivingRecordInfoSection({
    super.key,
    ...
    return Column(
      children: [
        ...
        Gs1ListRecordInfoBar(
          entityPlural: CancelReceivingUiConstants.entityPluralOperations,
