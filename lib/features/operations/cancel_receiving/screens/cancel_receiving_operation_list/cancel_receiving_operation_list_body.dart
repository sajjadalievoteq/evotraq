...
class CancelReceivingOperationListBody extends StatefulWidget {
  const CancelReceivingOperationListBody({
  ...
  @override
  State<CancelReceivingOperationListBody> createState() =>
      CancelReceivingOperationListBodyState();
}

class CancelReceivingOperationListBodyState
    extends State<CancelReceivingOperationListBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OperationsCubit<Operation>, OperationsState<Operation>>(
      ...
      builder: (context, state) {
          ...
          results: OperationListResults<Operation>(
            ...
            itemBuilder: (context, operation) => OperationListCard(
              ...
              isSelected:
                  ...
                  operation.navigableOperationId == widget.selectedOperationId,
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Cancel Receiving')),
          drawer: const AppDrawer(),
          floatingActionButton:
              widget.onEmbeddedCreate != null ||
