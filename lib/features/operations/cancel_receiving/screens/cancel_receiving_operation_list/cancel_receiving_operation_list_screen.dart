    ...
    return BlocProvider(
      create: (_) => OperationsCubit<Operation>(
        ...
        fetchList: ({required int page, required int size}) async {
          final pageResult = await getIt<CancelReceivingOperationService>()
              .getCancelReceivingOperationsPage(page: page, size: size);
          return pageResult.map((r) => r.toOperation());
        },
      )..loadInitial(),
      child: _CancelReceivingOperationListBody(
        embedded: embedded,
...
class _CancelReceivingOperationListBody extends StatefulWidget {
  const _CancelReceivingOperationListBody({
  ...
  @override
  State<_CancelReceivingOperationListBody> createState() =>
      _CancelReceivingOperationListBodyState();
}

class _CancelReceivingOperationListBodyState
    extends State<_CancelReceivingOperationListBody> {
  ...
  List<Operation> _filteredOperations(List<Operation> operations) {
    return CancelReceivingOperationListFilter.applyToOperations(
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
                    ...
                    ListenableBuilder(
                      ...
                      builder: (context, _) {
                        return Gs1ListSearchBar(
                          ...
                          sortTooltip: CancelReceivingUiConstants.sortByLine(
                            _sortFieldDisplayLabel(),
                            _sortDir == 'asc'
                                ? CancelReceivingUiConstants.sortAscendingLabel
                                : CancelReceivingUiConstants
                                    .sortDescendingLabel,
                          ),
                          sortOrder: _sortDir,
          ...
          results: OperationListResults<Operation>(
            ...
            emptyTitle: 'No cancel receiving operations yet',
            emptySubtitle:
                'Tap the + button to create your first cancel receiving operation.',
            emptyIconAsset: NavIcons.cancelReceiving,
