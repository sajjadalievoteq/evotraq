...
import 'package:traqtrace_app/features/operations/cancel_receiving/screens/cancel_receiving_operation_list/utils/cancel_receiving_operation_list_filter.dart';
import 'package:traqtrace_app/features/operations/cancel_receiving/screens/cancel_receiving_operation_list/widgets/cancel_receiving_advanced_filters_panel.dart';
import 'package:traqtrace_app/features/operations/cancel_receiving/screens/cancel_receiving_operation_list/widgets/cancel_receiving_operation_list_results.dart';
import 'package:traqtrace_app/features/operations/cancel_receiving/screens/cancel_receiving_operation_list/widgets/cancel_receiving_quick_filter_dialog.dart';
import 'package:traqtrace_app/features/operations/cancel_receiving/screens/cancel_receiving_operation_list/widgets/cancel_receiving_record_info_section.dart';
...
class CancelReceivingOperationListScreen extends StatefulWidget {
  ...
  @override
  State<CancelReceivingOperationListScreen> createState() =>
      _CancelReceivingOperationListScreenState();
}

class _CancelReceivingOperationListScreenState extends State<CancelReceivingOperationListScreen> {
  final TextEditingController _searchController = TextEditingController();
  final TextEditingController _gincFilterController =
      TextEditingController();
  final _scrollController = ScrollController();

  List<CancelReceivingResponse> _operations = [];
  int _totalRecords = 0;
  List<CancelReceivingResponse> _filteredOperations = [];
  ...
  void _showFilterDialog() {
    CancelReceivingQuickFilterDialog.open(
      context,
  ...
  void _showAdvancedFiltersDialog() {
    showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text(CancelReceivingUiConstants.advancedFiltersTitle),
        content: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 480),
          child: StatefulBuilder(
            builder: (context, setLocalState) {
              return CancelReceivingAdvancedFiltersPanel(
  ...
  String _sortFieldDisplayLabel() {
    return CancelReceivingUiConstants.sortFieldLabels[_sortBy] ??
        CancelReceivingUiConstants.sortFieldFallback;
  }
  ...
  Future<void> _loadOperations() async {
    ...
    try {
      ...
      final page = await shippingService.getCancelReceivingOperationsPage(page: 0);
      setState(() {
      ...
      setState(() {
        _errorMessage =
            'Could not load cancel receiving operations. Check your connection and tap Retry.';
      });
    } finally {
  ...
  Future<void> _loadMoreOperations() async {
    ...
    try {
      ...
      final page = await shippingService.getCancelReceivingOperationsPage(page: nextPage);
      setState(() {
  ...
  void _filterOperations() {
    setState(() {
      _filteredOperations = CancelReceivingOperationListFilter.apply(
  ...
  void _navigateToDetail(CancelReceivingResponse operation) {
  ...
  Widget build(BuildContext context) {
    final body = Gs1MasterListBody(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ListenableBuilder(
                  ...
                  builder: (context, _) {
                    return Gs1ListSearchBar(
                      hintText: CancelReceivingUiConstants.listSearchHint,
                ...
                CancelReceivingRecordInfoSection(
                ...
                Gs1ListSortingControls(
                  label: CancelReceivingUiConstants.sortByLine(
                    _sortFieldDisplayLabel(),
                    _sortDir == 'asc'
                        ? CancelReceivingUiConstants.sortAscendingLabel
                        : CancelReceivingUiConstants.sortDescendingLabel,
                  ),
                  sortOrder: _sortDir,
      ...
      results: CancelReceivingOperationListResults(
    ...
    return Scaffold(
      ...
      floatingActionButton: widget.onEmbeddedCreate != null
          ...
          : FloatingActionButton.extended(
              onPressed: () => context.go(Constants.opCancelReceivingCreateRoute),
