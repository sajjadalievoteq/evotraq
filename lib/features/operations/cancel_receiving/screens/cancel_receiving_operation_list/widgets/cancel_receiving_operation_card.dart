...
class CancelReceivingOperationCard extends StatelessWidget {
  const CancelReceivingOperationCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    final op = operation;
    final status = op.status ?? CancelReceivingStatus.failed;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: CancelReceivingStatusUtils.colorFor(status),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Text(
                      CancelReceivingStatusUtils.label(status),
              ...
              Text(
                op.cancelReceivingReference ?? 'Cancel Receiving',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
