...
part 'cancel_shipping_operations_state.dart';

class CancelShippingOperationsCubit extends Cubit<CancelShippingOperationsState> {
  CancelShippingOperationsCubit() : super(const CancelShippingOperationsState());
