...
import 'package:traqtrace_app/features/operations/cancel_shipping/screens/cancel_shipping_operation/widgets/cancel_shipping_scanned_items_list.dart';

class CancelShippingItemScanStep extends StatelessWidget {
  const CancelShippingItemScanStep({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final itemsList = CancelShippingScannedItemsList(
