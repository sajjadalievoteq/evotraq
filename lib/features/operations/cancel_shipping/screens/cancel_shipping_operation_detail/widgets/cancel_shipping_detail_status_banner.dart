...
class CancelShippingDetailStatusBanner extends StatelessWidget {
  const CancelShippingDetailStatusBanner({
    super.key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    operation.cancelShippingReference ?? 'Cancel Shipping Operation',
                  ...
                  if (operation.cancelShippingOperationId != null) ...[
                    ...
                    Text(
                      'ID: ${operation.cancelShippingOperationId}',
                      style: TextStyle(
