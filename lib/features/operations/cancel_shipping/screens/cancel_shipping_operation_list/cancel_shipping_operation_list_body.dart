...
class CancelShippingOperationListBody extends StatefulWidget {
  const CancelShippingOperationListBody({
  ...
  @override
  State<CancelShippingOperationListBody> createState() =>
      CancelShippingOperationListBodyState();
}

class CancelShippingOperationListBodyState
    extends State<CancelShippingOperationListBody> {
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
          ...
          results: OperationListResults<Operation>(
            ...
            emptyIconAsset: NavIcons.cancelShipping,
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Cancel Shipping')),
