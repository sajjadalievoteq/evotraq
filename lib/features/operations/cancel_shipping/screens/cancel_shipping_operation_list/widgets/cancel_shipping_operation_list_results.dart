...
import 'package:traqtrace_app/features/operations/cancel_shipping/screens/cancel_shipping_operation_list/widgets/cancel_shipping_operation_card.dart';
import 'package:traqtrace_app/features/operations/cancel_shipping/screens/cancel_shipping_operation_list/widgets/cancel_shipping_operation_list_error_view.dart';

/// List results area for shipping operation list screen.
class CancelShippingOperationListResults extends StatelessWidget {
  const CancelShippingOperationListResults({
    super.key,
  ...
  final List<CancelShippingResponse> filteredOperations;
  ...
  final ValueChanged<CancelShippingResponse> onOperationTap;
  final bool hasMore;
  ...
  Widget build(BuildContext context) {
    ...
    if (errorMessage != null) {
      return CancelShippingOperationListErrorView(
    ...
    if (filteredOperations.isEmpty) {
      return EmptyListView(
        ...
        title: 'No cancel shipping operations yet',
        subtitle:
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (index < filteredOperations.length) {
                ...
                return CancelShippingOperationCard(
                  operation: operation,
                  isSelected: embedded &&
