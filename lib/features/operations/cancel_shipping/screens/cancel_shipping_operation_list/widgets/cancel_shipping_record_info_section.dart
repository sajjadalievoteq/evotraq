...
class CancelShippingRecordInfoSection extends StatelessWidget {
  const CancelShippingRecordInfoSection({
    super.key,
    ...
    return Column(
      children: [
        ...
        Gs1ListRecordInfoBar(
          entityPlural: CancelShippingUiConstants.entityPluralOperations,
