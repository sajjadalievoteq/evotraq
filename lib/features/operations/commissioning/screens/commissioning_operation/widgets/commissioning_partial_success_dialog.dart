...
import 'package:traqtrace_app/features/operations/commissioning/screens/commissioning_operation/widgets/commissioning_partial_success_summary_row.dart';
...
class _CommissioningPartialSuccessDialogState
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Row(
        children: [
          TraqIcon(AppAssets.iconAlert, color: c.warning),
