...
/// Desktop three-column layout for Decommissioning operation wizard.
class DecommissioningOperationDesktopLayout extends StatelessWidget {
  const DecommissioningOperationDesktopLayout({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TraqAppBar(
        context,
        title: const Text('New Decommissioning Operation'),
      ),
            ...
            Expanded(
              child: OperationStepPanel(
                ...
                footer: OperationWizardNavButtons(
                  submitOnly: true,
                  onSubmit: onSubmit,
                  submitLabel: 'Create Decommissioning Operation',
                ),
                child: SingleChildScrollView(
                  padding: const EdgeInsets.all(16),
                  child: reviewStep,
