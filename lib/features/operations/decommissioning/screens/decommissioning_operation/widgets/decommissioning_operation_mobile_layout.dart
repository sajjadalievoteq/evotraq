...
/// Mobile wizard layout for Decommissioning operation screen.
class DecommissioningOperationMobileLayout extends StatelessWidget {
  const DecommissioningOperationMobileLayout({
    super.key,
