...
class DecommissioningScannedItemsList extends StatelessWidget {
  const DecommissioningScannedItemsList({
    super.key,
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  '${scannedEpcs.length} EPC(s) queued for decommissioning',
                  style: TextStyle(
                    fontSize: 12,
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return EpcHierarchyRow(
                    epc: epc,
                    hierarchyScreenTitle: 'Decommissioning Hierarchy',
