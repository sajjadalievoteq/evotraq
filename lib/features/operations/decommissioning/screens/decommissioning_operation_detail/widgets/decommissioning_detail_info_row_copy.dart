...
/// Copyable label/value row for Decommissioning detail cards.
class DecommissioningDetailInfoRowCopy extends StatelessWidget {
  const DecommissioningDetailInfoRowCopy({
    super.key,
    required this.label,
    required this.value,
  });
