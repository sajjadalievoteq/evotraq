...
/// Empty state for Decommissioning operation list.
class DecommissioningOperationListEmptyView extends StatelessWidget {
  const DecommissioningOperationListEmptyView({
    super.key,
        ...
        children: [
          ...
          Text(
            hasOperations
                ...
                : 'No Decommissioning operations yet',
          ...
          Text(
            hasOperations
                ...
                : 'Tap the + button to create your first Decommissioning operation.',
