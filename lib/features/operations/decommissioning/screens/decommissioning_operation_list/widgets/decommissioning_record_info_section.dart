...
class DecommissioningRecordInfoSection extends StatelessWidget {
  const DecommissioningRecordInfoSection({
    super.key,
    ...
    return Column(
      children: [
        ...
        Gs1ListRecordInfoBar(
          entityPlural: DecommissioningUiConstants.entityPluralOperations,
