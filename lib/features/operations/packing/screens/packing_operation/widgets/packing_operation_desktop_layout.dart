...
/// Desktop three-column layout for packing operation wizard.
class PackingOperationDesktopLayout extends StatelessWidget {
  const PackingOperationDesktopLayout({
    super.key,
