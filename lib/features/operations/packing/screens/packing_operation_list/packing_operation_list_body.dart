...
class PackingOperationListBody extends StatefulWidget {
  const PackingOperationListBody({
  ...
  @override
  State<PackingOperationListBody> createState() =>
      PackingOperationListBodyState();
}

class PackingOperationListBodyState extends State<PackingOperationListBody> {
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
          ...
          results: OperationListResults<Operation>(
            ...
            emptyIconAsset: NavIcons.packing,
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Packing Operation')),
