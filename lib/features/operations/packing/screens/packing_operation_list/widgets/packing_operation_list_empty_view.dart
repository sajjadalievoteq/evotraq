...
/// Empty state for packing operation list.
class PackingOperationListEmptyView extends StatelessWidget {
  const PackingOperationListEmptyView({
    super.key,
