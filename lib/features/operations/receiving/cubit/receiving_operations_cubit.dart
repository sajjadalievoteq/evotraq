...
part 'receiving_operations_state.dart';

class ReceivingOperationsCubit extends Cubit<ReceivingOperationsState> {
  ReceivingOperationsCubit() : super(const ReceivingOperationsState());
