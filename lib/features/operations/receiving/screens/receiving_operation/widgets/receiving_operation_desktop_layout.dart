...
/// Desktop three-column layout for Receiving operation wizard.
class ReceivingOperationDesktopLayout extends StatelessWidget {
  const ReceivingOperationDesktopLayout({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TraqAppBar(
        context,
        title: const Text('New Receiving Operation'),
      ),
