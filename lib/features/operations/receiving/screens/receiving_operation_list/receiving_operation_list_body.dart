...
class ReceivingOperationListBody extends StatefulWidget {
  const ReceivingOperationListBody({
  ...
  @override
  State<ReceivingOperationListBody> createState() =>
      ReceivingOperationListBodyState();
}

class ReceivingOperationListBodyState
    extends State<ReceivingOperationListBody> {
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
          ...
          results: OperationListResults<Operation>(
            ...
            emptyIconAsset: NavIcons.receiving,
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Receiving Operation')),
          ...
          floatingActionButton:
              ...
              : FloatingActionButton.extended(
                  onPressed: () =>
                      context.push(Constants.opReceivingCreateRoute),
