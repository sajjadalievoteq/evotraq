...
import 'package:traqtrace_app/features/operations/receiving/screens/receiving_operation_list/receiving_operation_list_body.dart';
...
class ReceivingOperationListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ReceivingOperationListBody(
        embedded: embedded,
