...
/// List results area for Receiving operation list screen.
class ReceivingOperationListResults extends StatelessWidget {
  const ReceivingOperationListResults({
    super.key,
  ...
  final List<ReceivingResponse> filteredOperations;
  ...
  final ValueChanged<ReceivingResponse> onOperationTap;
  final bool hasMore;
  ...
  Widget build(BuildContext context) {
    ...
    if (errorMessage != null) {
      return ReceivingOperationListErrorView(
    ...
    if (filteredOperations.isEmpty) {
      return EmptyListView(
        ...
        title: 'No Receiving operations yet',
        subtitle: 'Tap the + button to create your first Receiving operation.',
