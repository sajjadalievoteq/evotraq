...
import 'package:traqtrace_app/features/operations/return_receiving/screens/return_receiving_operation/widgets/return_receiving_scanned_items_list.dart';

/// Step 2: scan or manually enter items for return receiving.
class ReturnReceivingItemScanStep extends StatelessWidget {
  const ReturnReceivingItemScanStep({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final itemsList = ReturnReceivingScannedItemsList(
