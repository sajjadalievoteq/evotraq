...
/// Desktop three-column layout for ReturnReceiving operation wizard.
class ReturnReceivingOperationDesktopLayout extends StatelessWidget {
  const ReturnReceivingOperationDesktopLayout({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TraqAppBar(
        context,
        title: const Text('New Return Receiving'),
      ),
