...
/// Mobile wizard layout for ReturnReceiving operation screen.
class ReturnReceivingOperationMobileLayout extends StatelessWidget {
  const ReturnReceivingOperationMobileLayout({
    super.key,
