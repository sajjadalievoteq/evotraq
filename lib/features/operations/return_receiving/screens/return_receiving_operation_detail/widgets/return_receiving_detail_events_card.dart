...
/// EPCIS events card for Return Receiving operation detail.
class ReturnReceivingDetailEventsCard extends StatelessWidget {
  const ReturnReceivingDetailEventsCard({
    super.key,
