...
/// Copyable label/value row for Return Receiving Detail cards.
class ReturnReceivingDetailInfoRowCopy extends StatelessWidget {
  const ReturnReceivingDetailInfoRowCopy({
    super.key,
    required this.label,
    required this.value,
  });
