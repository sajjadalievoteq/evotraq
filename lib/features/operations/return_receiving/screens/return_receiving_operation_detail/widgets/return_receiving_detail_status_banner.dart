...
/// Status banner with background image for Return Receiving operation detail.
class ReturnReceivingDetailStatusBanner extends StatelessWidget {
  const ReturnReceivingDetailStatusBanner({
    super.key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    operation.returnReceivingReference ?? 'Return Receiving Operation',
                  ...
                  if (operation.returnReceivingOperationId != null) ...[
                    ...
                    Text(
                      'ID: ${operation.returnReceivingOperationId}',
                      style: TextStyle(
