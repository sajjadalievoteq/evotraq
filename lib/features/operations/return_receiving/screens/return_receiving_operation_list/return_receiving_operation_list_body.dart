...
class ReturnReceivingOperationListBody extends StatefulWidget {
  const ReturnReceivingOperationListBody({
  ...
  @override
  State<ReturnReceivingOperationListBody> createState() =>
      ReturnReceivingOperationListBodyState();
}

class ReturnReceivingOperationListBodyState
    extends State<ReturnReceivingOperationListBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OperationsCubit<Operation>, OperationsState<Operation>>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Return Receiving')),
