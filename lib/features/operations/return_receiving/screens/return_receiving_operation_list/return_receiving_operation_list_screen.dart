...
import 'package:traqtrace_app/features/operations/return_receiving/screens/return_receiving_operation_list/return_receiving_operation_list_body.dart';
...
class ReturnReceivingOperationListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ReturnReceivingOperationListBody(
        embedded: embedded,
