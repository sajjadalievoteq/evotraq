...
/// Empty state for ReturnReceiving operation list.
class ReturnReceivingOperationListEmptyView extends StatelessWidget {
  const ReturnReceivingOperationListEmptyView({
    super.key,
        ...
        children: [
          ...
          Text(
            hasOperations
                ...
                : 'No ReturnReceiving operations yet',
