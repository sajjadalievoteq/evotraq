...
class ReturnReceivingOperationListResults extends StatelessWidget {
  const ReturnReceivingOperationListResults({
    super.key,
  ...
  final List<ReturnReceivingResponse> filteredOperations;
  ...
  final ValueChanged<ReturnReceivingResponse> onOperationTap;
  final bool hasMore;
