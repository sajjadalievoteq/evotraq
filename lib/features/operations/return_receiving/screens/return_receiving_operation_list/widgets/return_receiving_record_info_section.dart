...
class ReturnReceivingRecordInfoSection extends StatelessWidget {
  const ReturnReceivingRecordInfoSection({
    super.key,
    ...
    return Column(
      children: [
        ...
        Gs1ListRecordInfoBar(
          entityPlural: ReturnReceivingUiConstants.entityPluralOperations,
