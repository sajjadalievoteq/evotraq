...
class ReturnShippingDetailStatusBanner extends StatelessWidget {
  const ReturnShippingDetailStatusBanner({
    super.key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    operation.returnReference ?? 'Return Shipping Operation',
                  ...
                  if (operation.returnShippingOperationId != null) ...[
                    ...
                    Text(
                      'ID: ${operation.returnShippingOperationId}',
                      style: TextStyle(
