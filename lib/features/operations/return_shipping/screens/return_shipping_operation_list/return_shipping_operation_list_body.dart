...
class ReturnShippingOperationListBody extends StatefulWidget {
  const ReturnShippingOperationListBody({
  ...
  @override
  State<ReturnShippingOperationListBody> createState() =>
      ReturnShippingOperationListBodyState();
}

class ReturnShippingOperationListBodyState
    extends State<ReturnShippingOperationListBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OperationsCubit<Operation>, OperationsState<Operation>>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Return Shipping')),
