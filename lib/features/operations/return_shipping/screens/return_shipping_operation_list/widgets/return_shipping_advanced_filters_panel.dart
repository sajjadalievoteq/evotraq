    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          initialValue: sortBy,
          decoration: const InputDecoration(
            labelText: ReturnShippingUiConstants.labelSortResultsBy,
            border: OutlineInputBorder(),
            contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 8),
          ),
          items: ReturnShippingUiConstants.sortFieldLabels.entries
              .map(
          ...
          children: [
            ...
            Expanded(
              child: CustomButtonWidget(
                title: ReturnShippingUiConstants.buttonApply,
                onTap: onApply,
              ),
            ),
          ],
