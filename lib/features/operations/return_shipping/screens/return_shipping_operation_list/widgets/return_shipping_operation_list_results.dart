...
import 'package:traqtrace_app/features/operations/return_shipping/screens/return_shipping_operation_list/widgets/return_shipping_operation_card.dart';
import 'package:traqtrace_app/features/operations/return_shipping/screens/return_shipping_operation_list/widgets/return_shipping_operation_list_empty_view.dart';
import 'package:traqtrace_app/features/operations/return_shipping/screens/return_shipping_operation_list/widgets/return_shipping_operation_list_error_view.dart';

/// List results area for shipping operation list screen.
class ReturnShippingOperationListResults extends StatelessWidget {
  const ReturnShippingOperationListResults({
    super.key,
  ...
  final List<ReturnShippingResponse> filteredOperations;
  ...
  final ValueChanged<ReturnShippingResponse> onOperationTap;
  final bool hasMore;
  ...
  Widget build(BuildContext context) {
    ...
    if (errorMessage != null) {
      return ReturnShippingOperationListErrorView(
    ...
    if (filteredOperations.isEmpty) {
      return ReturnShippingOperationListEmptyView(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (index < filteredOperations.length) {
                ...
                return ReturnShippingOperationCard(
                  operation: operation,
                  isSelected: embedded &&
