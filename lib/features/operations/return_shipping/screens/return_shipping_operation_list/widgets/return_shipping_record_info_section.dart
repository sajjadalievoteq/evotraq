...
class ReturnShippingRecordInfoSection extends StatelessWidget {
  const ReturnShippingRecordInfoSection({
    super.key,
    ...
    return Column(
      children: [
        ...
        Gs1ListRecordInfoBar(
          entityPlural: ReturnShippingUiConstants.entityPluralOperations,
