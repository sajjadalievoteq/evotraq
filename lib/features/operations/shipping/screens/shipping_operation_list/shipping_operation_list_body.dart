...
class ShippingOperationListBody extends StatefulWidget {
  const ShippingOperationListBody({
  ...
  @override
  State<ShippingOperationListBody> createState() =>
      ShippingOperationListBodyState();
}

class ShippingOperationListBodyState extends State<ShippingOperationListBody> {
  ...
  void _showFilterDialog() {
    ShippingQuickFilterDialog.open(
      context,
  ...
  void _showAdvancedFiltersDialog() {
    showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text(ShippingUiConstants.advancedFiltersTitle),
        content: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 480),
          child: StatefulBuilder(
            builder: (context, setLocalState) {
              return ShippingAdvancedFiltersPanel(
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
          ...
          results: OperationListResults<Operation>(
            ...
            emptyIconAsset: NavIcons.shipping,
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Shipping Operation')),
          ...
          floatingActionButton:
              ...
              : FloatingActionButton.extended(
                  onPressed: () =>
                      context.push(Constants.opShippingCreateRoute),
