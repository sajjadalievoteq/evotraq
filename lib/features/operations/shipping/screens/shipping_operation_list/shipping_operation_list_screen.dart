...
import 'package:traqtrace_app/features/operations/shipping/screens/shipping_operation_list/shipping_operation_list_body.dart';
...
class ShippingOperationListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ShippingOperationListBody(
        embedded: embedded,
