...
class ShippingOperationCard extends StatelessWidget {
  const ShippingOperationCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    final op = operation;
    final status = op.status ?? ShippingStatus.failed;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: ShippingStatusUtils.colorFor(status),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Text(
                      ShippingStatusUtils.label(status),
              ...
              Text(
                op.shippingReference ?? 'Shipping Operation',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
