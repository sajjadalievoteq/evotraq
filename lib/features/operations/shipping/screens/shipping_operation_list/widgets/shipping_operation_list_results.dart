...
import 'package:traqtrace_app/features/operations/shipping/screens/shipping_operation_list/widgets/shipping_list_item_skeleton.dart';
...
class ShippingOperationListResults extends StatelessWidget {
  const ShippingOperationListResults({
    super.key,
  ...
  final List<ShippingResponse> filteredOperations;
  ...
  final ValueChanged<ShippingResponse> onOperationTap;
  final bool hasMore;
    ...
    if (isLoading) {
      return AppShimmer(
        child: ListView.builder(
          ...
          itemCount: 6,
          itemBuilder: (context, _) => const ShippingListItemSkeleton(),
        ),
      );
    }

    if (errorMessage != null) {
      return ShippingOperationListErrorView(
