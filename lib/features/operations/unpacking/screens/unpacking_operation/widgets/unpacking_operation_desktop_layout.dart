...
/// Desktop three-column layout for unpacking operation wizard.
class UnpackingOperationDesktopLayout extends StatelessWidget {
  const UnpackingOperationDesktopLayout({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TraqAppBar(
        context,
        title: const Text('New Unpacking Operation'),
      ),
