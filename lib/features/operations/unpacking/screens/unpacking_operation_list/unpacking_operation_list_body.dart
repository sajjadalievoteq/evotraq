...
class UnpackingOperationListBody extends StatefulWidget {
  const UnpackingOperationListBody({
  ...
  @override
  State<UnpackingOperationListBody> createState() =>
      UnpackingOperationListBodyState();
}

class UnpackingOperationListBodyState
    extends State<UnpackingOperationListBody> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OperationsCubit<Operation>, OperationsState<Operation>>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: TraqAppBar(context, title: const Text('Unpacking Operation')),
          drawer: const AppDrawer(),
          floatingActionButton: !context.canPerform(OperationSteps.unpack)
              ? null
              : FloatingActionButton.extended(
                  onPressed: () =>
                      context.push(Constants.opUnpackingCreateRoute),
