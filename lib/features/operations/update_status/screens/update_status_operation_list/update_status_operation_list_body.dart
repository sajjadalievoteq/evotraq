...
class UpdateStatusOperationListBody extends StatefulWidget {
  const UpdateStatusOperationListBody({
  ...
  @override
  State<UpdateStatusOperationListBody> createState() =>
      UpdateStatusOperationListBodyState();
}

class UpdateStatusOperationListBodyState
    extends State<UpdateStatusOperationListBody> {
      ...
      builder: (context, state) {
        ...
        final body = Gs1MasterListBody(
          ...
          results: OperationListResults<Operation>(
            ...
            emptyIconAsset: NavIcons.updateStatus,
