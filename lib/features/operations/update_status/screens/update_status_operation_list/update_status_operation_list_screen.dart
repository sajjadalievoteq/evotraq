...
import 'package:traqtrace_app/features/operations/update_status/screens/update_status_operation_list/update_status_operation_list_body.dart';
...
class UpdateStatusOperationListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: UpdateStatusOperationListBody(
        embedded: embedded,
