...
import 'package:traqtrace_app/features/tatmeen_integration/screens/dashboard/widgets/tatmeen_chart_legend_dot.dart';
import 'package:traqtrace_app/features/tatmeen_integration/screens/dashboard/widgets/tatmeen_chart_skeleton.dart';
  ...
  Widget build(BuildContext context) {
      ...
      bars.add(
        BarChartGroupData(
          ...
          barRods: [
            ...
            BarChartRodData(toY: failed, width: 5, color: context.colors.error),
          ],
        ),
      );
    }
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            TatmeenChartLegendDot(label: 'Successful', color: colors.success),
            const SizedBox(width: TraqSpacing.md),
            TatmeenChartLegendDot(label: 'Failed', color: colors.error),
          ],
        ),
      ],
    );
